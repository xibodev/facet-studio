#!/bin/bash
# Build macOS .app bundle for Facet Studio Launcher
...
LAUNCHER_EXECUTABLE="facet-studio-launcher-${EXECUTABLE}"
EXECUTABLE="facet-studio-${EXECUTABLE}"
echo "executable: $EXECUTABLE"

APP_NAME="Facet Studio Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="facet-studio-launcher"
...
if [ -f "./build/${EXECUTABLE}" ]; then
    cp "./build/${EXECUTABLE}" "${APP_MACOS}/facet-studio"
else
...
<dict>
    ...
    <string>facet-studio-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.facet-studio.launcher</string>
