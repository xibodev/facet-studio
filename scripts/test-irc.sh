...
CONTAINER_NAME="facet-studio-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.facet-studio/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run facet-studio:"
echo "  cd packages/facet-studio && go run ./cmd/facet-studio gateway"
echo ""
