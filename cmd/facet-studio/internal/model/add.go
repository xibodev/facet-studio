...
Sample interactive session (key shown masked):
    ...
    ✓ Saved model 'custom-prefer' (deepseek-r1-250120) and set as default.`,
		Example: `  facet-studio model add --api-base https://api.openai.com/v1 --api-key sk-...
  facet-studio model add -b http://localhost:8000/v1 -k dummy -m my-model -n local`,
		Args: cobra.NoArgs,
