...
func initTest(t *testing.T) {
	...
	_ = os.Setenv("FACET_STUDIO_CONFIG", configPath)
}
...
func TestSetDefaultModel_SaveConfigError(t *testing.T) {
	...
	// A path under a FILE cannot be a directory on any platform. The previous
	// value, "/nonexistent/directory/config.json", is merely a missing
	// directory -- which Windows resolves onto the current drive and happily
	// creates, so the save succeeded and the error never came.
