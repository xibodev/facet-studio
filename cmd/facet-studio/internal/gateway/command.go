...
import (
	...
	"github.com/xibodev/facet-studio/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "gateway",
		Aliases: []string{"g"},
		Short:   "Start facet-studio gateway",
		Args:    cobra.NoArgs,
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			return gateway.Run(debug, internal.GetFacetStudioHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
