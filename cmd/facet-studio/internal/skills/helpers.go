...
func skillsInstallBuiltinCmd(workspace string) {
	builtinSkillsDir := "./facet-studio/skills"
...
func skillsListBuiltinCmd() {
	...
	builtinSkillsDir := filepath.Join(filepath.Dir(cfg.WorkspacePath()), "facet-studio", "skills")
...
func skillsSearchCmd(query string) {
	...
	for _, result := range results {
		...
		if result.RegistryName == "github" {
			fmt.Printf("     Install: facet-studio skills install %s\n", result.Slug)
		} else {
			fmt.Printf("     Install: facet-studio skills install --registry=%s %s\n", result.RegistryName, result.Slug)
		}
		fmt.Println()
	}
}
