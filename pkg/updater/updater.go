...
func DownloadAndExtractRelease(releaseURL, platform, arch string) (string, error) {
	...
	tmpPattern := "facet-studio-release-*"
	...
	// Extract
	destDir, err := os.MkdirTemp("", "facet-studio-extract-*")
	if err != nil {
		os.Remove(tmpPath)
		return "", err
	}
...
// Example: owner="sky5454" -> https://api.github.com/repos/sky5454/facet-studio/releases/latest
func GetReleaseAPIURL(owner string) string {
	return fmt.Sprintf("https://api.github.com/repos/%s/facet-studio/releases/latest", owner)
}
...
// Example: owner="sipeed", tag="nightly" -> https://api.github.com/repos/sipeed/facet-studio/releases/tags/nightly
func GetReleaseTagAPIURL(owner, tag string) string {
	return fmt.Sprintf("https://api.github.com/repos/%s/facet-studio/releases/tags/%s", owner, tag)
}
