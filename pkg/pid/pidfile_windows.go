...
// isFacetStudioProcess uses QueryFullProcessImageNameW to confirm the
// process image name contains "facet-studio". Returns false when the name
...
func isFacetStudioProcess(pid int) bool {
	...
	return strings.Contains(name, "facet-studio")
}
