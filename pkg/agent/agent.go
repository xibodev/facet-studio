...
import (
	...
	"github.com/xibodev/facet-studio/pkg/agent/interfaces"
	"github.com/xibodev/facet-studio/pkg/audio/asr"
	"github.com/xibodev/facet-studio/pkg/bus"
	"github.com/xibodev/facet-studio/pkg/commands"
	...
	"github.com/xibodev/facet-studio/pkg/routing"
...
type AgentLoop struct {
	...
	// plain conversational runtime. Full Studio injects one backed by the
	...
	instanceSelectionResolver InstanceSelectionResolver
}
...
func (al *AgentLoop) Close() {
	...
	//
	// Not every manager holds one: the legacy manager is a view over the loop
