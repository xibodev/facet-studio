...
import (
	...
	"github.com/xibodev/facet-studio/pkg/providers/protocoltypes"
	"github.com/xibodev/facet-studio/pkg/seahorse"
	"github.com/xibodev/facet-studio/pkg/session"
	"github.com/xibodev/facet-studio/pkg/tokenizer"
)
...
// Close releases the engine's SQLite handle.
//
// AgentLoop.Close asks every context manager for this, and until it did, the
// handle stayed open for the life of the process -- invisible on Linux, and on
// Windows a directory that could not be removed.
