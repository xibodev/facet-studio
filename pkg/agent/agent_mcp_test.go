...
import (
	...
	"github.com/xibodev/facet-studio/pkg/mcp"
	agenttools "github.com/xibodev/facet-studio/pkg/tools"
)
	...
	cfg.Tools = config.ToolsConfig{
		MCP: config.MCPConfig{
			...
			Servers: map[string]config.MCPServerConfig{
				"broken": {
					Enabled: true,
					Command: "facet-studio-command-that-does-not-exist-for-mcp-tests",
				},
			},
		},
	}
