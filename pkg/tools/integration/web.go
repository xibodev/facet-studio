...
const (
	...
	userAgentHonest = "facet-studio/%s (+https://github.com/xibodev/facet-studio; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(
	...
	// Format results in standard Facet Studio format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies facet-studio, which some
