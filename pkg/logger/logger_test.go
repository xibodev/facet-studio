...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/facet-studio_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("FACET_STUDIO_LOG_FILE", tmpFile)
	defer os.Unsetenv("FACET_STUDIO_LOG_FILE")
	...
	os.Setenv("FACET_STUDIO_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
...
func TestConfigureFromEnvNoEnv(t *testing.T) {
	os.Unsetenv("FACET_STUDIO_LOG_FILE")
	ConfigureFromEnv()
}
