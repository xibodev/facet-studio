...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		// owner it is given, whoever that is.
		{
			...
			repo:         "sipeed/facet-studio",
			wantOwner:    "sipeed",
			wantRepoName: "facet-studio",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "sipeed/facet-studio/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "facet-studio",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/xibodev/facet-studio/tree/dev/skills/test",
			wantOwner:    "xibodev",
			wantRepoName: "facet-studio",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/xibodev/facet-studio/blob/main/README.md",
			wantOwner:    "xibodev",
			wantRepoName: "facet-studio",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/xibodev/facet-studio",
			wantOwner:    "xibodev",
			wantRepoName: "facet-studio",
			wantRef:      "main",
			wantSubPath:  "",
		...
		},
		{
			...
			repo:           "https://gitlab.com/sipeed/facet-studio/-/tree/main/skills/test",
			wantErr:        true,
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "facet-studio")
	...
	err = installer.InstallFromGitHub(context.Background(), "sipeed/facet-studio")
	if err == nil {
