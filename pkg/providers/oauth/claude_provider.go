...
import (
	...
	anthropicprovider "github.com/xibodev/facet-studio/pkg/providers/anthropic"
)
...
func CreateClaudeTokenSource(getCredential func(string) (*auth.AuthCredential, error)) func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: facet-studio auth login --provider anthropic")
		}
