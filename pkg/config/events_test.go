...
func TestLoadConfigEventLoggingEnvOverrides(t *testing.T) {
	t.Setenv("FACET_STUDIO_EVENTS_LOGGING_ENABLED", "false")
	t.Setenv("FACET_STUDIO_EVENTS_LOGGING_INCLUDE", "gateway.*,channel.lifecycle.*")
	t.Setenv("FACET_STUDIO_EVENTS_LOGGING_EXCLUDE", "gateway.ready")
	t.Setenv("FACET_STUDIO_EVENTS_LOGGING_MIN_SEVERITY", "error")
	t.Setenv("FACET_STUDIO_EVENTS_LOGGING_INCLUDE_PAYLOAD", "true")
