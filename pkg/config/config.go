...
import (
	...
	providercommon "github.com/xibodev/facet-studio/pkg/providers/common"
)
...
// IsolationConfig controls subprocess isolation for commands started by Facet Studio.
...
type AgentDefaults struct {
	...
	SubTurn                   SubTurnConfig      `json:"subturn"                                                                                      envPrefix:"FACET_STUDIO_AGENTS_DEFAULTS_SUBTURN_"`
...
type FeishuSettings struct {
	...
	RandomReactionEmoji FlexibleStringSlice `json:"random_reaction_emoji"       yaml:"-"                            env:"FACET_STUDIO_CHANNELS_FEISHU_RANDOM_REACTION_EMOJI"`
...
type MaixCamSettings struct {
	Host string `json:"host" yaml:"-" env:"FACET_STUDIO_CHANNELS_MAIXCAM_HOST"`
	Port int    `json:"port" yaml:"-" env:"FACET_STUDIO_CHANNELS_MAIXCAM_PORT"`
}
...
// email-based, end-to-end encrypted messenger; Facet Studio talks to a local
...
// only for legacy Facet Studio-managed email configuration.
...
type LINESettings struct {
	...
	ChannelAccessToken SecureString `json:"channel_access_token,omitzero" yaml:"channel_access_token,omitempty" env:"FACET_STUDIO_CHANNELS_LINE_CHANNEL_ACCESS_TOKEN"`
...
type HeartbeatConfig struct {
	Enabled  bool `json:"enabled"  env:"FACET_STUDIO_HEARTBEAT_ENABLED"`
	Interval int  `json:"interval" env:"FACET_STUDIO_HEARTBEAT_INTERVAL"` // minutes, min 5
}

type DevicesConfig struct {
	Enabled    bool `json:"enabled"     env:"FACET_STUDIO_DEVICES_ENABLED"`
	MonitorUSB bool `json:"monitor_usb" env:"FACET_STUDIO_DEVICES_MONITOR_USB"`
}
...
type DuckDuckGoConfig struct {
	Enabled    bool `json:"enabled"     env:"FACET_STUDIO_TOOLS_WEB_DUCKDUCKGO_ENABLED"`
	MaxResults int  `json:"max_results" env:"FACET_STUDIO_TOOLS_WEB_DUCKDUCKGO_MAX_RESULTS"`
}

type SogouConfig struct {
	Enabled    bool `json:"enabled"     env:"FACET_STUDIO_TOOLS_WEB_SOGOU_ENABLED"`
	MaxResults int  `json:"max_results" env:"FACET_STUDIO_TOOLS_WEB_SOGOU_MAX_RESULTS"`
}
...
type SearXNGConfig struct {
	Enabled    bool   `json:"enabled"     env:"FACET_STUDIO_TOOLS_WEB_SEARXNG_ENABLED"`
	BaseURL    string `json:"base_url"    env:"FACET_STUDIO_TOOLS_WEB_SEARXNG_BASE_URL"`
	MaxResults int    `json:"max_results" env:"FACET_STUDIO_TOOLS_WEB_SEARXNG_MAX_RESULTS"`
}
...
type ToolsConfig struct {
	...
	AppendFile      ToolConfig         `json:"append_file"       yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_APPEND_FILE_"`
	EditFile        ToolConfig         `json:"edit_file"         yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_EDIT_FILE_"`
	FindSkills      ToolConfig         `json:"find_skills"       yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_FIND_SKILLS_"`
	I2C             ToolConfig         `json:"i2c"               yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_I2C_"`
	InstallSkill    ToolConfig         `json:"install_skill"     yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_INSTALL_SKILL_"`
	ListDir         ToolConfig         `json:"list_dir"          yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_LIST_DIR_"`
	LoadImage       ToolConfig         `json:"load_image"        yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_LOAD_IMAGE_"`
	Message         MessageToolsConfig `json:"message"           yaml:"-"`
	ReadFile        ReadFileToolConfig `json:"read_file"         yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_READ_FILE_"`
	Serial          ToolConfig         `json:"serial"            yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_SERIAL_"`
	SendFile        ToolConfig         `json:"send_file"         yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_SEND_FILE_"`
	SendTTS         ToolConfig         `json:"send_tts"          yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_SEND_TTS_"`
	Spawn           ToolConfig         `json:"spawn"             yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_SPAWN_"`
	SpawnStatus     ToolConfig         `json:"spawn_status"      yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_SPAWN_STATUS_"`
	SPI             ToolConfig         `json:"spi"               yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_SPI_"`
	Subagent        ToolConfig         `json:"subagent"          yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_SUBAGENT_"`
	WebFetch        ToolConfig         `json:"web_fetch"         yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_WEB_FETCH_"`
	WriteFile       ToolConfig         `json:"write_file"        yaml:"-"                                                       envPrefix:"FACET_STUDIO_TOOLS_WRITE_FILE_"`
}
...
type SearchCacheConfig struct {
	MaxSize    int `json:"max_size"    env:"FACET_STUDIO_SKILLS_SEARCH_CACHE_MAX_SIZE"`
	TTLSeconds int `json:"ttl_seconds" env:"FACET_STUDIO_SKILLS_SEARCH_CACHE_TTL_SECONDS"`
}
...
const (
	envSkillsClawHubEnabled         = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_ENABLED"
	envSkillsClawHubBaseURL         = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_BASE_URL"
	envSkillsClawHubAuthToken       = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_AUTH_TOKEN"
	envSkillsClawHubSearchPath      = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_SEARCH_PATH"
	envSkillsClawHubSkillsPath      = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_SKILLS_PATH"
	envSkillsClawHubDownloadPath    = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_DOWNLOAD_PATH"
	envSkillsClawHubTimeout         = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_TIMEOUT"
	envSkillsClawHubMaxZipSize      = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_MAX_ZIP_SIZE"
	envSkillsClawHubMaxResponseSize = "FACET_STUDIO_SKILLS_REGISTRIES_CLAWHUB_MAX_RESPONSE_SIZE"
	envSkillsGitHubEnabled          = "FACET_STUDIO_SKILLS_REGISTRIES_GITHUB_ENABLED"
	envSkillsGitHubBaseURL          = "FACET_STUDIO_SKILLS_REGISTRIES_GITHUB_BASE_URL"
	envSkillsGitHubAuthToken        = "FACET_STUDIO_SKILLS_REGISTRIES_GITHUB_AUTH_TOKEN"
	envSkillsGitHubProxy            = "FACET_STUDIO_SKILLS_REGISTRIES_GITHUB_PROXY"
)
