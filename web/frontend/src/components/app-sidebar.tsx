...
// Inherited chat-channel integrations are restored to sidebar.
const SHOW_CHANNELS = true
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const navGroups: NavGroup[] = React.useMemo(() => {
    return [
      ...
      // Channels are inherited from the donor: twenty-plus chat integrations
      // for a general-purpose bot. Facet Studio is a local-first agentic chat
      // that expands through modules, so they are hidden from navigation rather
      // than removed -- the routes and backend still work for anyone who wants
      // them, and hiding is reversible in a way deleting is not.
      ...(SHOW_CHANNELS
        ? [
            {
