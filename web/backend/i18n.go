...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open Facet Studio console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About Facet Studio",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit Facet Studio",
		Exiting:            "Exiting Facet Studio...",
		DocUrl:             "https://docs.facetstudio.dev/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 Facet Studio 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 Facet Studio",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 Facet Studio",
		Exiting:            "正在退出 Facet Studio...",
		DocUrl:             "https://docs.facetstudio.dev/zh-Hans/docs/",
	},
}
