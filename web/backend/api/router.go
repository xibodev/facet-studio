...
func NewHandler(configPath string) *Handler {
	...
	h.providerCredentialResolver = resolveProviderCredentialReference
	h.providerCatalogHTTPClient = http.DefaultClient
	h.providerCatalogSync = h.syncCompatibleProviderCatalog
	return h
}
...
// When explicit is true, hostInput is the normalized -host / FACET_STUDIO_LAUNCHER_HOST value.
