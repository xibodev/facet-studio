...
import (
	...
	"github.com/xibodev/facet-studio/pkg/memory"
...
// It reads the workspace from config, falling back to ~/.facet-studio/workspace.
...
func resolveSessionsDir(workspace string) string {
	if workspace == "" {
		...
		workspace = filepath.Join(home, ".facet-studio", "workspace")
	}
