...
func TestHandleListSkills(t *testing.T) {
	...
	oldBuiltin := os.Getenv("FACET_STUDIO_BUILTIN_SKILLS")
	if err := os.Setenv("FACET_STUDIO_BUILTIN_SKILLS", builtinRoot); err != nil {
		t.Fatalf("Setenv(FACET_STUDIO_BUILTIN_SKILLS) error = %v", err)
	}
	defer func() {
		if oldBuiltin == "" {
			_ = os.Unsetenv("FACET_STUDIO_BUILTIN_SKILLS")
		} else {
			_ = os.Setenv("FACET_STUDIO_BUILTIN_SKILLS", oldBuiltin)
		}
	}()
